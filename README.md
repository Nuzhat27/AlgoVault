...
- **App:** [algo-vault-iota.vercel.app](https://algo-vault-iota.vercel.app/)
- **API:** [algovault-j8pm.onrender.com](https://algovault-j8pm.onrender.com)
...
```env
VITE_API_URL=https://algovault-j8pm.onrender.com/api
```
...
CLIENT_URL=https://algo-vault-iota.vercel.app
```
...
2. Add the required backend environment variables in Render, including `CLIENT_URL` set to the deployed Vercel frontend URL (needed for CORS).
3. Deploy the frontend to Vercel.
4. Set `VITE_API_URL` in Vercel to the Render backend API URL (including `/api`).
